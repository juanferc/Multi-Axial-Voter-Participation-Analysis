...
def Voters():
    ...
    education = session.query(Vdata.zip_code, Vdata.less_than_grade_9_est, Vdata.high_school_non_grad_est, Vdata.high_school_grad_est, Vdata.some_college_no_degree_est, Vdata.associates_degree_est, Vdata.bachelor_degree_est, Vdata.grad_or_professional_degree_est,
                              Vdata.registration_rate, Vdata.turnout_rate, Vdata.latitude, Vdata.longitude, Vdata.population, Vdata.num_registered_voters, Vdata.num_voted, Vdata.did_not_vote, Vdata.average_house_value, Vdata.average_income).all()
    session.close()
